...
import { GameState, GameAction, Difficulty, KlondikeMode, ValidMove, findValidMoves } from '@/types/cards';
...
export const createGameStore = create<GameStateStore>((set, get) => ({

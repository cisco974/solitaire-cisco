  ...
  return (
    <StandardPage title="Privacy Policy">
      <p className="lead text-xl text-gray-600 mb-8">
        At SLTR.com, we take your privacy seriously. This Privacy Policy
      ...
      <p>
        ...
        our website and hold certain information. Cookies are files with small

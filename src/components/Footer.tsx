      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        <div className="flex flex-col items-center gap-8">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between w-full gap-6">
            ...
            >
              <div className="flex space-x-1">
                <div className="w-8 h-10 bg-white rounded-md flex items-center justify-center text-red-600 shadow-lg transform hover:scale-105 transition-transform">
                  ♥
                </div>
                <div className="w-8 h-10 bg-white rounded-md flex items-center justify-center text-red-600 shadow-lg transform hover:scale-105 transition-transform">
                  ♦
                </div>
                <div className="w-8 h-10 bg-white rounded-md flex items-center justify-center text-gray-900 shadow-lg transform hover:scale-105 transition-transform">
                  ♠
                </div>
                <div className="w-8 h-10 bg-white rounded-md flex items-center justify-center text-gray-900 shadow-lg transform hover:scale-105 transition-transform">
                  ♣
          ...
          <div className="w-full">
            <h2 className="text-white/70 text-sm mb-4 text-center">
              Available Languages
            </h2>

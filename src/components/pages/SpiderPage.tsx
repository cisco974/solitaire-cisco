...
import SpiderSolitaire from "@app/spider/page";
import { SpiderMode } from "../../../react-old/src/types/spiderCards";
import { SpiderContent } from "../../../react-old/src/components/SpiderContent";
    ...
    <div className="flex-1">
      ...
      <main className="flex-1">
        <div className="max-w-4xl mx-auto px-2 sm:px-4 py-4 sm:py-8">
          ...
          <div className="mt-8">
            <GameDescription gameType="spider" />
            <div className="mt-16">
              <SpiderContent />
            </div>
          </div>

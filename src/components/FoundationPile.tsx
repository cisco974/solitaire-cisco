...
import { CardBackStyle } from "@/types/customization";
      ...
      className={`
        ...
        ${
          pile.length > 0
            ...
            : isLight
              ? "bg-white/10 backdrop-blur-sm border-2 border-dashed border-white/30"
    ...
    >
      {pile.length === 0 && (
        <div className="absolute inset-0 flex items-center justify-center">
          ...
          >
            <span
              className={`text-2xl font-bold ${isLight ? "text-white/60" : "text-white/40"}`}
            >
              A
            </span>
          </motion.div>
